export const tutorialPosts = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Pada cell 5 kita mengubah bentuk data agar cocok untuk LSTM. Kita mengubah data dari dua dimensi menjadi tiga dimensi dengan menambahkan dimensi baru untuk fitur. Dalam hal ini, kita hanya memiliki satu fitur yaitu angka itu sendiri. Setelah itu kita bisa langsung melatih model LSTM pada cell 6 dengan kode berikut :",
    ],  
    images: [
      "/assets/ship.webp",
      "",
